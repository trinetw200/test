...
import L_HouseManagement_List from './screens/Landlord/L_HouseManagement/L_HouseManagement_List';
  ...
  return (
      <NavigationContainer>
        ...
        {/* <Stack.Navigator screenOptions={{
          ...
          <Stack.Screen name="L_HouseManagement_List" component={L_HouseManagement_List} />
