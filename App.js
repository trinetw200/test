...
import T_TabNavigator from './screens/Tenant/T_TabNavigator';
...
function App() {
  ...
  return (
    ...
    headerShown: false}} initialRouteName="T_TabNavigato">
          ...
          <Stack.Screen name="T_TabNavigator" component={T_TabNavigator} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
